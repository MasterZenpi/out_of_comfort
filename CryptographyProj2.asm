...
InputLoop    GETC		        ; Begin of InputLoop, gets characterinput
	     ...
	     ;Add code here    		; Stores input character in R0 into memory location in R1
...
;                                        ;
EncryptLoop 
	     ;Add code here    		; Load the value in the memory location pointed by R3 with 0 Offeset into R0
